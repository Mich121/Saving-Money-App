...
class AddRevenue(QWidget):
    ...
    def widgets(self):
        ...
        self.addRevenueTitle = QLabel("ADD REVENUE")
        ...
        self.activityEntry.setPlaceholderText("For what...")
    ...
    def addRevenue(self):
        ...
        if (name and amount != ""):
            try:
                query = "INSERT INTO 'revenue' (revenueamount, revenuename) VALUES(?,?)"
                cur.execute(query, (amount, name))
                con.commit()
