import style, addrevenue, addspending, globalvariable
...
class Window(QMainWindow):
    ...
    def widgets(self):
        ...
        self.homeSpending = QLabel(f"{globalvariable.homespending} PLN")
        ...
        self.busSpending = QLabel(f"{globalvariable.busspending} PLN")
        ...
        self.clothesSpending = QLabel(f"{globalvariable.clothesspending} PLN")
        ...
        self.eatSpending = QLabel(f"{globalvariable.eatspending} PLN")
        ...
        self.phoneSpending = QLabel(f"{globalvariable.phonespending} PLN")
        ...
        self.carSpending = QLabel(f"{globalvariable.carspending} PLN")
        ...
        self.economySpending = QLabel(f"{globalvariable.economy} PLN")
        ...
        self.Salary = QLabel(f"Salary: {round(globalvariable.salary, 2)} PLN")
        ...
        self.Spend = QLabel(f"Spend: {round(globalvariable.spend, 2)} PLN")
        ...
        self.Saldo = QLabel(f"Saldo: {round(globalvariable.salary - globalvariable.spend - globalvariable.economy, 2)} PLN")
    ...
    def funcSaldoFigure(self):
        if globalvariable.salary != 0.0:
            slices = [globalvariable.salary - globalvariable.spend, globalvariable.spend - globalvariable.economy, globalvariable.economy]
    ...
    def funcGenerateFigure(self):
        if globalvariable.spend > 0:   
            ###option with circle diagram
            #slices = [globalvariable.homespending, globalvariable.busspending, globalvariable.clothesspending, globalvariable.eatspending, globalvariable.phonespending, globalvariable.carspending]
            ...
            parts = {'home': globalvariable.homespending, 'transport': globalvariable.busspending, 'fashion': globalvariable.clothesspending,'food': globalvariable.eatspending, 'gadgets': globalvariable.phonespending, 'car': globalvariable.carspending}
            colours = ['#7DFBFF', '#FF0D0D', '#FF00E6', '#3BFF5B', '#412BFF', '#B17DFF']
    ...
    def getValues(self):
        ...
        if allRevenues[0][0] != None:
            globalvariable.salary = allRevenues[0][0]
        self.Salary.setText(f"Salary: {round(globalvariable.salary, 2)}")

        allSpending = cur.execute("SELECT SUM(spendingamount) FROM spending").fetchall()
        if allSpending[0][0] != None:
            globalvariable.spend = allSpending[0][0]
        self.Spend.setText(f"Spend: {round(globalvariable.spend, 2)}")

        self.Saldo.setText(f"Saldo: {round(globalvariable.salary - globalvariable.spend, 2)}")

        allHomeSpending = cur.execute("SELECT SUM(homespending) FROM spendingcategories").fetchall()
        if allHomeSpending[0][0] != None:
            globalvariable.homespending = allHomeSpending[0][0]
        self.homeSpending.setText(f"{round(globalvariable.homespending, 2)} PLN")
        allBusSpending = cur.execute("SELECT SUM(busspending) FROM spendingcategories").fetchall()
        if allBusSpending[0][0] != None:
            globalvariable.busspending = allBusSpending[0][0]
        self.busSpending.setText(f"{round(globalvariable.busspending, 2)} PLN")
        allClothesSpending = cur.execute("SELECT SUM(clothesspending) FROM spendingcategories").fetchall()
        if allClothesSpending[0][0] != None:
            globalvariable.clothesspending = allClothesSpending[0][0]
        self.clothesSpending.setText(f"{round(globalvariable.clothesspending, 2)} PLN")
        allFoodSpending = cur.execute("SELECT SUM(eatspending) FROM spendingcategories").fetchall()
        if allFoodSpending[0][0] != None:
            globalvariable.eatspending = allFoodSpending[0][0]
        self.eatSpending.setText(f"{round(globalvariable.eatspending, 2)} PLN")
        allPhoneSpending = cur.execute("SELECT SUM(phonespending) FROM spendingcategories").fetchall()
        if allPhoneSpending[0][0] != None:
            globalvariable.phonespending = allPhoneSpending[0][0]
        self.phoneSpending.setText(f"{round(globalvariable.phonespending, 2)} PLN")
        allCarSpending = cur.execute("SELECT SUM(carspending) FROM spendingcategories").fetchall()
        if allCarSpending[0][0] != None:
            globalvariable.carspending = allCarSpending[0][0]
        self.carSpending.setText(f"{round(globalvariable.carspending, 2)} PLN")
        allEconomy = cur.execute("SELECT SUM(economy) FROM spendingcategories").fetchall()
        if allEconomy[0][0] != None:
            globalvariable.economy = allEconomy[0][0]
        self.economySpending.setText(f"{round(globalvariable.economy, 2)} PLN")
    ...
    def funcAddSpending(self):
        if (globalvariable.salary > 0.0 and globalvariable.salary > globalvariable.spend):  #we cant add spending without money
            self.addspending = addspending.AddSpending()
        else:
